...
output "public_subnets_tags_all" { ## 태그 값 추가 
...
output "private_subnets_tags_all" { ## 태그 값 추가 
...
output "outpost_subnets_tags_all" { ## 태그 값 추가 
  description = "List of cidr_blocks of outpost subnets"
  value       = aws_subnet.outpost[*].tags_all[*]
}
...
output "database_subnets_tags_all" { ## 태그 값 추가 
...
output "redshift_subnets_tags_all" { ## 태그 값 추가 
  description = "List of cidr_blocks of redshift subnets"
  value       = aws_subnet.redshift[*].tags_all[*]
}
...
output "elasticache_subnets_tags_all" { ## 태그 값 추가 
  description = "List of cidr_blocks of elasticache subnets"
  value       = aws_subnet.elasticache[*].tags_all[*]
}
...
output "intra_subnets_tags_all" { ## 태그 값 추가 
  description = "List of cidr_blocks of intra subnets"
  value       = aws_subnet.intra[*].tags_all[*]
}
